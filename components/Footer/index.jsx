...
const Footer = () => {
  ...
  return (
    <>
      <div className="relative grid grid-cols-2 md:grid-cols-4 gap-4 p-4 border-t-2 border-black">
        ...
        <div>
          ...
          <form className="my-2">
            ...
            />
            <button className="bg-gray-800 hover:bg-gray-900 px-6 py-2 my-2 text-white">
              SUBSCRIBE
            </button>
          </form>
        </div>
      ...
      <div className="text-center my-4">
        <p className="text-sm text-gray-700">
          &copy;{getYear.getFullYear()} - Theoyoth - All rights reserved
        </p>
      </div>
    </>
  );
