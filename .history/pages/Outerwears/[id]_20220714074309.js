...
const Detail = ({ data }) => {
  ...
  return (
    <Layout title="Detail">
      <div className="grid grid-cols-1 md:grid-cols-2 min-h-screen mt-16 border border-1 border-black">
        <div className="w-full h-[100%] bg-gray-200 flex justify-center">
          <Image src={data?.url} alt={data?.name} width="600" height="500" />
        </div>
