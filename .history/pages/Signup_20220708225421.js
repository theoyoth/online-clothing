  ...
  return (
    <div className="relative h-screen grid place-items-center">
      <div className="w-1/2 border border-1 border-black py-4">
        ...
        <form className="w-full flex flex-col justify-center items-center mt-4 py-4 border-t-2 border-black">
          <div className="w-3/4">
            <label
              htmlFor="email"
          ...
          <button className="w-full py-2 bg-gray-900 text-center text-white hover:bg-gray-700 duration-150 ease-out">
            Register
          </button>
        </form>
      </div>
