...
const Detail = ({ data }) => {
  const amount = usesStore((state) => state.cart);
  const addAmount = usesStore((state) => state.addAmount);
  const reduceAmount = usesStore((state) => state.reduceAmount);
  const addToBasket = usesStore((state) => state.addToBasket);
  const removeFromBasket = usesStore((state) => state.removeFromCart);
