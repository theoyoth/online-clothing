    ...
    <div>
      ...
      {items.map((item, i) => (
        <ul className="text-sm my-2" key={i}>
          <Link href="/">
            <a>
              <li className="before:content-[''] before:absolute before:bottom-0 before:left-0 before:h-1 before:bg-black before:w-0 hover:before:w-full duration-200 ease-in-out">
                {item}
              </li>
            </a>
          </Link>
