    ...
    <div>
      ...
      {items.map((item, i) => (
        <ul className="text-sm my-2" key={i}>
          <Link href="/" passHref>
            <li>
              <a className="relative before:content-[''] before:absolute before:-bottom-1 before:left-0 before:h-[1px] before:bg-black before:w-0 hover:before:w-full before:marker:duration-200 before:ease-in-out cursor-pointer">
                {item}
              </a>
            </li>
          </Link>
