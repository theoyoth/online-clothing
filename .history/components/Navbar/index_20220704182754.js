    ...
    <>
      <div className="relative flex items-center md:items-center md:justify-between bg-gray-100 z-[2]">
        ...
        <nav
          className={`${
            isMenuOpen
              ? "grid translate-y-[146px] transition-transform duration-500 ease-in-out place-items-center z-0 border border-1 border-black"
              : "hidden -translate-y-1/2 transition-transform duration-500 ease-in-out"
          } w-full px-2 py-4 text-center absolute left-0 bg-gray-100 md:z-0 md:flex md:w-[80%] md:justify-between md:items-center md:translate-y-[0] md:py-0 md:px-0 md:text-black md:relative`}
        >
