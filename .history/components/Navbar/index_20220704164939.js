  ...
  return (
    <>
      <div className="relative flex items-center bg-gray-100">
        ...
        >
          <ul className="md:flex md:basis-1/2 md:justify-between md:items-center md:text-black border border-1 border-black">
            <li className="my-2 w-full relative border border-1 border-black">
              <Link href="/shirt">
