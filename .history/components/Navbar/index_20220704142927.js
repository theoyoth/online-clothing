    ...
    <>
      <div className="relative flex items-center bg-gray-100">
        ...
        <nav
          className={`${
            isMenuOpen
              ? "block translate-y-[0px] opacity-100"
              : "hidden opacity-0 -translate-y-1/2"
          } transition-all duration-500 ease-in-out -translate-y-1/2 w-full px-2 py-4 text-center absolute left-0 top-[55px] bg-gray-100`}
        >
          <div>
            <ul className="">
