    ...
    <>
      <div className="fixed top-0 left-0 w-full flex items-center md:justify-between bg-gray-100 z-[10]">
        ...
        <nav
          ...
          } fixed left-0 top-0 w-full py-4 text-center bg-gray-100 z-[2] md:z-0 md:flex md:w-[80%] md:justify-between md:items-center md:translate-y-[0] md:py-0 md:px-0 md:text-black md:relative md:opacity-100`}
        >
          <ul className="md:flex md:basis-1/2 md:justify-between md:items-center md:text-black lg:basis-1/3">
            <NavLink href="Shirt" />
            <NavLink href="Outerwear" />
            <NavLink href="Accessories" />
          </ul>
          <div className="md:flex md:basis-2/5 lg:basis-[20%] md:justify-between md:items-center">
        ...
        <button className="md:pr-2 md:w-[40px] md:translate-x-0 translate-x-[75%]">
          <FaShoppingCart />
        </button>
        <button
