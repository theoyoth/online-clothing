        ...
        <nav
          className={`${
            isMenuOpen
              ...
              : "hidden"
          } transition duration-150 ease-in-out -translate-y-1/2 bg-white w-full px-2 py-4 text-center absolute left-0 top-[55px]`}
        >
          <div
            className={`${
              isMenuOpen
                ? "block translate-y-[0px] transition duration-200 ease-in-out"
                : "hidden"
            } transition duration-150 ease-in-out -translate-y-1/2`}
          >
            <ul className="">
