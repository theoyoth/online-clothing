    ...
    <>
      <div className="relative flex md:space-between items-center bg-gray-100">
        ...
        <nav
          ...
          } w-full px-2 py-4 text-center absolute left-0 bg-gray-100 z-10 md:z-0 md:flex md:w-full md:items-center md:translate-y-[0] md:text-gray-900 md:relative md:border md:border-1 md:border-black`}
        >
          <ul className="md:flex md:w-3/4 md:space-between md:text-black md:border md:border-1 md:border-black">
          ...
          <ul className="mt-4 md:mt-0 md:flex md:border md:border-1 md:border-black md:w-1/2">
            <li className="my-2 relative w-full before:content-[''] before:w-0 before:bg-black before:h-[1px] before:absolute before:bottom-0 before:left-0 hover:before:w-full before:transition-all before:duration-100 before:ease-in">
              <Link href="/login">
                <a>Login</a>
              </Link>
