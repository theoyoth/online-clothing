    ...
    <>
      <div className="fixed top-0 left-0 w-full flex items-center md:justify-between bg-white z-[10] border-b-[1px] border-black px-4">
        ...
        >
          ...
          <ul className="md:flex md:basis-3/5 md:justify-between md:items-center md:text-black md:font-semibold lg:basis-1/3">
            <NavLink href="Shirts" />
          ...
          <div className="md:flex md:basis-1/3 lg:basis-[20%] md:justify-end md:items-center">
            <ul className="mt-4 md:mt-0 md:flex md:justify-between md:items-center md:font-semibold md:w-3/5 w-full">
              <NavLink href="Login" />
              <NavLink href="Signup" />
            </ul>
          </div>
