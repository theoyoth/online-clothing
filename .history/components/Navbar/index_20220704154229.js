        ...
        <nav
          className={`${
            isMenuOpen
              ...
              : "hidden opacity-0 -translate-y-1/2 transition-transform duration-500 ease-in-out"
          } w-full px-2 py-4 text-center absolute left-0 bg-gray-100 z-10 md:flex md:text-gray-800`}
        >
          <ul className="">
