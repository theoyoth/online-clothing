  ...
  return (
    <>
      <div className="relative flex items-center bg-gray-100">
        ...
        >
          <ul className="">
            <li className="relative w-full before:content-[''] before:w-0 before:bg-black before:h-[1px] before:absolute before:bottom-0 before:left-0 hover:before:w-full transition duration-200 ease-in">
              Shirt
            </li>
