    ...
    <>
      <div className="relative flex items-center bg-gray-100">
        ...
        <nav
          ...
          } w-full px-2 py-4 text-center absolute left-0 bg-gray-100 z-10 md:z-0 md:flex md:w-3/4 md:text-gray-900 md:border md:border-1 md:border-black md:relative`}
        >
