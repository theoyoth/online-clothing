    ...
    <>
      <div className="relative flex items-center bg-gray-100">
        ...
        <nav
          ...
          } w-full px-2 py-4 text-center absolute left-0 bg-gray-100 z-10 md:z-0 md:flex md:w-full md:translate-y-[0] md:text-gray-900 md:border md:border-1 md:border-black md:relative`}
        >
          <ul className="md:flex md:w-3/4 md:space-between md:text-gray-900 md:border md:border-1 md:border-black">
            <li className="my-2 md:my-0 relative w-full before:content-[''] before:w-0 before:bg-black before:h-[1px] before:absolute before:bottom-0 before:left-0 hover:before:w-full before:transition-all before:duration-100 before:ease-in">
              <Link href="/shirt">
                <a>Shirt</a>
              </Link>
            </li>
