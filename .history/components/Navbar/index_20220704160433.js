      ...
      <div className="relative flex md:space-between items-center bg-gray-100">
        ...
        >
          <ul className="md:flex md:w-3/4 md:space-between md:text-black md:border md:border-1 md:border-black">
            ...
            <li className="my-2 relative w-full before:content-[''] before:w-0 before:bg-black before:h-[1px] before:absolute before:left-0 hover:before:w-full before:transition-all before:duration-100 before:ease-in">
              <Link href="/outerwear">
                <a>Outerwear</a>
              </Link>
            </li>
