...
const Navbar = () => {
  ...
  return (
    <>
      <div className="relative flex items-center md:justify-between bg-gray-100 z-[2]">
        ...
        <nav
          className={`${
            isMenuOpen
              ? "translate-y-[148px] duration-200 ease-in-out z-[-1]"
              : "-translate-y-[100%] duration-200 ease-in-out z-[-1]"
          } absolute left-0 w-full px-2 py-4 text-center bg-gray-100 md:z-0 md:flex md:w-[80%] md:justify-between md:items-center md:translate-y-[0] md:py-0 md:px-0 md:text-black md:relative`}
        >
