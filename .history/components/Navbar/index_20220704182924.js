    ...
    <>
      <div className="relative flex items-center md:items-center md:justify-between bg-gray-100 z-[2]">
        ...
        <nav
          className={`${
            isMenuOpen
              ? "grid translate-y-[148px] transition-transform duration-500 ease-in-out place-items-center z-0 absolute left-0"
              : "hidden -translate-y-1/2 duration-200 ease-in-out"
