...
const Navbar = () => {
  ...
  return (
    <>
      <div className="relative flex items-center md:justify-between bg-gray-100 z-100">
        ...
        <nav
          ...
          } absolute left-0 w-full px-2 py-4 text-center bg-gray-100 z-10 md:z-0 md:flex md:w-[80%] md:justify-between md:items-center md:translate-y-[0] md:py-0 md:px-0 md:text-black md:relative`}
        >
