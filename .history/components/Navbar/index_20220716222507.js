...
const Navbar = () => {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 w-full flex items-center md:justify-between bg-white z-[10] border-b-[1px] border-black">
        ...
        >
          ...
          <div className="md:flex md:basis-1/3 lg:basis-[20%] md:justify-between md:items-center">
            <ul className="mt-4 md:mt-0 md:flex md:justify-around md:items-center w-full border border-1 border-black">
              <NavLink href="Login" />
              <NavLink href="Signup" />
            </ul>
          </div>
        </nav>
        <div className="md:pr-2 md:w-[40px] md:translate-x-0 translate-x-[75%] z-10">
          <FaShoppingCart />
        </div>
        <button
