...
const Navbar = () => {
  ...
  return (
    <>
      <div className="relative flex items-center md:items-center md:justify-between bg-gray-100 border border-1 border-black">
        <div className="border border-1 border-black md:py-0">
          <Logo />
        </div>
        <nav
          className={`${
          ...
          } w-full px-2 py-4 text-center absolute left-0 bg-gray-100 z-10 md:z-0 md:flex md:w-[95%] md:justify-between md:items-center md:translate-y-[0] md:py-0 md:px-0 md:text-black md:relative`}
        >
