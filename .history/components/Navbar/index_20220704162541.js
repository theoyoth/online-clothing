    ...
    <>
      <div className="relative flex md:space-between items-center bg-gray-100">
        ...
        <nav
          ...
          } w-full px-2 py-4 text-center absolute left-0 bg-gray-100 z-10 md:z-0 md:flex md:w-full md:space-between md:items-center md:translate-y-[0] md:py-0 md:text-black md:relative border border-1 border-black`}
        >
