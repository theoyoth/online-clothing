      ...
      <div>
        ...
        <form className="my-2">
          <input
            ...
            className="text-sm w-full px-4 py-2 border-b-2 border-black focus:outline-none active:border-t-2 active:border-black focus:border-t-2 focus:border-black relative"
          />
